export const DEFAULT_FONT_STACK = 'Inter, "Segoe UI", system-ui, -apple-system, sans-serif'
export const MONO_FONT_STACK = '"JetBrains Mono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace'
